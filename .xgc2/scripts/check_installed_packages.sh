...
test -f "/opt/ros/${ROS_DISTRO}/share/gazebo_sim_mecanum/models/xgc2_mecanum_ugv/meshes/mecanum_wheel_left.STL"
...
GAZEBO_MODEL_PATH="/opt/ros/${ROS_DISTRO}/share/gazebo_sim_mecanum/models:${GAZEBO_MODEL_PATH:-}" \
